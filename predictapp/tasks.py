...
def get_backtest_task_asyn(ticker, commission=0.0, file=None, period='D'):
    '''
    :param ticker: string
    ...
    try:
        ...
        if (backtest_summary.empty or backtest_detail.empty) and not df.empty:
            ...
            backtest_summary, backtest_detail = run_backtest(df, commission, ticker)
...
def run_backtest(df, commission, ticker):
